...
# VIEW SETS: Simpler than views because no need to create separate classes for list vs. detail
...
class GenericArticleAPIView(generics.GenericAPIView, mixins.ListModelMixin, mixins.CreateModelMixin):
    ...
    # 3 auth options: Sessions, Basic, and Token
    # authentication_classes = [SessionAuthentication, BasicAuthentication] # Check if theres session, if not then use basic
